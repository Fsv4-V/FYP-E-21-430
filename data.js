...
const WEEKS = [
  ...
  },
  {
    ...
    "evidence": "During Week 10, we moved from planning into our first practical fabrication trial. We first prepared a sketch for the portable disposable plaster and then produced a handmade flexible trace prototype using locally available materials. Surgical-glove material was used only as a temporary flexible substrate, adhesive copper foil was applied to it, and a screen-printing and etching process was used to form the copper tracks. After etching, the prototype was cleaned, insulated with additional rubber layers and fully sealed to protect the conductive paths. This first model helped us verify the trace layout and fabrication sequence, although it was not yet a calibrated or medical-grade sensing patch. In parallel, we met staff from the Department of Chemical and Process Engineering and completed the chemical requirement list, risk-assessment forms, SDS/MSDS documentation, laboratory procedure and emergency-response guidance needed for PANI preparation. The required chemicals were not available in the department stores, and commercial suppliers offered them only in costly bulk quantities. We therefore contacted the Department of Chemistry, Faculty of Science, University of Peradeniya, where the main laboratory confirmed that the required chemical facilities could be supported. The next step is to arrange departmental borrowing of small quantities and begin the supervised laboratory preparation work."
  },
  {
    "id": 11,
    "label": "Week 11",
