...
const WEEKS = [
  ...
  },
  {
    ...
    "keyFindings": [
      ...
      "A first handmade flexible trace prototype was fabricated using a temporary surgical-glove substrate, adhesive copper foil, screen-printing and etching, followed by cleaning, insulation and sealing. This was a fabrication and routing trial, not a calibrated or medical-grade sensing patch.",
      ...
      "No completed PANI synthesis, validated sensor calibration, human testing or clinical validation is claimed for Week 10."
    ],
    ...
    "highlight": {
      "title": "Laboratory Coordination and Chemical Preparation",
      "text": "During Week 10, we visited the chemical laboratory of the Department of Chemical and Process Engineering to confirm the requirements for PANI preparation, including laboratory access, chemical availability, risk assessment, SDS/MSDS documentation and safe operating procedures. As the required chemicals were not available in suitable small quantities and commercial suppliers required costly bulk purchases, we contacted the Department of Chemistry, Faculty of Science, University of Peradeniya. The main laboratory confirmed that the necessary chemical support could be provided, allowing us to plan the supervised PANI preparation stage for the following week."
    },
    "evidence": "The Week 10 Drive folder contains the full progress report, fabrication planning documents, PANI preparation records, safety forms and supporting project resources."
  },
  {
    "id": 11,
    "label": "Week 11",
