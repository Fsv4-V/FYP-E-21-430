...
(() => {
  ...
  updateWeek(11, {
    ...
    phase: "TMP117, Tiny-SMD Practice and Initial CMJ Feedback · 28 July 2026",
    title: "Week 11 — TMP117 Study, Tiny-SMD Soldering Practice, STM32 Planning and Initial Manuscript Feedback",
    status: "Completed",
    resourceLink: "#",
    images: [
      {
        src: "assets/week11/Week11_Intro_Summary.png",
        caption: "Generated Week 11 introduction summarising the TMP117 study, tiny-SMD soldering practice, required materials and planned STM32 temperature interface."
      },
      {
        src: "assets/week11/Week11_Solder_Paste_Original.jpg",
        caption: "Original project photograph of the special solder paste selected for miniature SMD practice."
      },
      {
        src: "assets/week11/Week11_Fine_Soldering_Reference.png",
        caption: "Reference tutorial screenshot used to study fine-tip soldering of miniature surface-mount pads; this is not a photograph of the project prototype."
      },
      {
        src: "assets/week11/Week11_Hot_Air_Stencil_Reference.png",
        caption: "Reference tutorial screenshot used to understand stencil alignment and controlled hot-air soldering; this is process-learning evidence only."
      },
      {
        src: "assets/week11/Week11_TMP117_Specification_Reference.png",
        caption: "TMP117 reference-video screenshot used to review the sensor's accuracy, digital resolution and package requirements."
      },
      {
        src: "assets/week11/Week11_TMP117_Interface_Reference.png",
        caption: "Reference connection concept used while planning the TMP117 I²C interface and display/indicator workflow before STM32 implementation."
      }
    ],
    folders: [
    ...
    decisions: "Use a practice component before soldering the actual TMP117; keep the hot-air flow low; apply only a small, controlled quantity of solder paste; verify orientation under magnification; develop the STM32 temperature-reading interface before connecting any heater, fan or actuator stage; and create a section-by-section checklist for responding to the initial Colombo Medical Journal comments.",
    rejected: "Directly soldering the actual TMP117 without practice, using uncontrolled high airflow, applying excessive paste and describing tutorial screenshots as original project evidence were rejected. The planned STM32 control interface is not yet reported as a completed closed-loop controller.",
    nextWeek: "Collect and organise the required electrode chemicals, confirm laboratory safety and process requirements, revise the Colombo Medical Journal draft using the Week 11 comments, and request or record the next round of feedback.",
    evidence: "Original evidence includes the solder-paste photograph and the team's practical SMD trials. Reference videos: <a href=\"https://www.youtube.com/watch?v=skDwEgYY1UA\" target=\"_blank\" rel=\"noopener\">Tiny-SMD soldering tutorial</a> and <a href=\"https://www.youtube.com/watch?v=XHfyc8TiGmM\" target=\"_blank\" rel=\"noopener\">TMP117 precision temperature-sensor tutorial</a>. The initial Colombo Medical Journal revision work is supported by the supervisor's written comments and the team's comment checklist. Generated summary graphics are presentation aids and are identified separately from original photographs."
  });

  /* ---------------- WEEK 12 ---------------- */
  updateWeek(12, {
    dates: "Materials obtained Friday, 31 July 2026",
    phase: "Chemical Collection and CMJ Draft Revision · 31 July 2026",
    title: "Week 12 — Chemical Collection, Laboratory Preparation and Colombo Medical Journal Draft Revision",
    status: "Completed",
    resourceLink: "#",
    images: [
      {
        src: "assets/week12/Week12_Intro_Summary.png",
        caption: "Generated Week 12 introduction summarising chemical collection, laboratory preparation, safety planning and process review."
      },
      {
        src: "assets/week12/Week12_AgCl_Label_Original.jpg",
        caption: "Original project photograph showing the analytical-grade silver chloride container and supplier-label information."
      },
      {
        src: "assets/week12/Week12_AgCl_Sample_Original.jpg",
        caption: "Original project photograph of the silver chloride container and the prepared sample tube for the next laboratory stage."
      },
      {
        src: "assets/week12/Week12_AgCl_Materials_Original.jpg",
        caption: "Original project photograph showing the collected silver chloride and sample material organised for supervised laboratory work."
      }
    ],
    folders: [
    ...
    decisions: "Record the Friday collection date, preserve the original material photographs, complete the safety and process checklist before laboratory work, revise the Colombo Medical Journal manuscript manually using tracked comments, and verify each corrected statement against the relevant source before accepting it.",
    rejected: "Reporting Wednesday as the collection date, presenting material collection as completed sensor fabrication, placing figures or tables without in-text references and submitting unreviewed AI-generated manuscript text were rejected.",
    nextWeek: "Study the complete electrode-fabrication sequence for the PANI working electrode and Ag/AgCl reference electrode, review screen-printing and polymerization steps, and complete the next section-by-section Colombo Medical Journal correction cycle using the additional comments recorded in Week 12.",
    evidence: "Original evidence consists of the three silver-chloride and sample-tube photographs taken during material collection and organisation. The generated Week 12 summary is a presentation aid. Colombo Medical Journal revision evidence is based on the corrected draft, the supervisor's written feedback, the cited source material used for verification and the team's updated comment checklist."
  });

  /* ---------------- WEEK 13 ---------------- */
  updateWeek(13, {
    dates: "Portfolio updated 2 August 2026",
    phase: "Electrode Process Study and CMJ Correction Cycle · 2 August 2026",
    title: "Week 13 — Electrode Fabrication Process Study, PANI Preparation and Continued Colombo Medical Journal Revision",
    status: "Completed",
    resourceLink: "assets/week13/CMJ_Current_Revised_Manuscript_38_References.pdf",
    images: [
      {
        src: "assets/week13/Week13_Intro_Summary.png",
        caption: "Generated Week 13 introduction summarising the electrode architecture, screen-printing sequence and PANI polymerization preparation."
      },
      {
        src: "assets/week13/CMJ_Manuscript_Title_Page.png",
        caption: "Actual screenshot of page 1 of the current revised Colombo Medical Journal manuscript. The working draft is titled ‘Smart Wound Dressings for Chronic Diabetic Wounds: Translating Wound-Bed Feedback into Clinician-Led Decision Support’."
      },
      {
        src: "assets/week13/CMJ_References_31_to_38_and_Appendix.png",
        caption: "Actual screenshot of page 13 of the current revised manuscript, showing references 31–38 and the beginning of Supplementary Appendix A. This is manuscript-development evidence, not a published-journal page."
      },
      {
        src: "assets/week13/Week13_Electrode_Structure_Reference.png",
        caption: "Reference-video screenshot identifying the working, counter and pseudoreference regions of a screen-printed electrochemical electrode."
      },
      {
        src: "assets/week13/Week13_Mask_Preparation_Reference.png",
        caption: "Reference-video screenshot used to study mask preparation before conductive-ink printing; not original project-fabrication evidence."
      },
      {
        src: "assets/week13/Week13_Ink_Application_Reference.png",
        caption: "Reference-video screenshot showing conductive-ink preparation and application during a screen-printing demonstration."
      },
      {
        src: "assets/week13/Week13_Ink_Spreading_Reference.png",
        caption: "Reference-video screenshot showing controlled ink spreading across the prepared pattern."
      },
      {
        src: "assets/week13/Week13_Drying_Reference.png",
        caption: "Reference-video screenshot showing the drying stage used after printing the electrode pattern."
      },
      {
        src: "assets/week13/Week13_PANI_Polymerization_Reference.png",
        caption: "Reference screenshot used to understand electrochemical polymerization and PANI growth on an electrode surface."
      },
      {
        src: "assets/week13/Week13_Post_Processing_Reference.png",
        caption: "Reference screenshot used to study filtration or post-processing of synthesized polymer material."
      }
    ],
    folders: [
